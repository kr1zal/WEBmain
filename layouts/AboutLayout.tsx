    ...
    <>
      ...
      <div className="mt-5">
        ...
        <P>
          ...
          300 тысяч до 26 миллионов рублей в месяц: <Hn>x87</Hn>.
        </P>
        <P>
        ...
        <P>
          ...
          направлений. Сегодня они управляют отделами в крупных компаниях. Текучесть в моей
          бизнес-единице — <Hn>3%</Hn>.
        </P>
      </div>
