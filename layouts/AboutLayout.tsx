  ...
  return (
    <>
      ...
      <div className="mt-5">
        ...
        <P>
          Параллельно занимался performance-маркетингом на международных рынках. Google, Facebook,
          Instagram. CPA-модели, сложные воронки, разные гео — я научился считать трафик как
          продукт: стоимость привлечения, конверсия на каждом этапе, возврат на вложенный рубль.
        </P>
        <P>
      ...
      <div className="mt-5">
        ...
        <P>
          Параллельно шёл осознанный переход в корпоративную среду. Первый опыт: агентство
      ...
      <div className="mt-5">
        ...
        <P>
          <Strong>Политика.</Strong> Пять кампаний. Муниципальный, региональный, федеральный
          уровень. Каждая — полный digital-стек с нуля: SEO, YouTube, Instagram, Дзен, TikTok,
          таргетированная и контекстная реклама, медийные кампании, наружная реклама, инфлюенсеры,
          публикации в СМИ. Часть кампаний усиливал автоматизированными контентными воронками — до 2
          млн просмотров в месяц. Воронка обеспечивает максимальный охват и узнаваемость кандидата
          на каждом этапе кампании. Результат — <Hn>5 из 5 побед</Hn>. Детали под NDA.
        </P>
      </div>
