...
const chapters = [
  ...
  { id: 'ch4', label: 'Глава IV', title: 'Цифровая трансформация', toc: 'Цифровая трансформация' },
  { id: 'ch5', label: 'Глава V', title: 'Команда', toc: 'Команда' },
  { id: 'ch6', label: 'Глава VI', title: 'Другие проекты', toc: 'Другие проекты' },
...
function StoryContent() {
  return (
    <>
      ...
      {/* Ch 4 */}
      <ChapterHeading id="ch4" label="Глава IV" title="Цифровая трансформация" />
      <div className="mt-5">
        <P>
          Фабрика мебели: собственное производство, логистика, складская инфраструктура, розничная
          сеть, несколько брендов. E-commerce на момент моего прихода — ноль.
        </P>
        <P>
        ...
        <P>
          ...
          крупногабарита. Выручка выросла с 300 тысяч до 26 миллионов рублей в месяц.
        </P>
        <P>
          Когда объёмы стабилизировались, начал автоматизировать. Digital-аналитика, бюджеты, SMM,
          call center — всё, что можно было передать AI, я передал.{' '}
          <Hn>70% операционных процессов автоматизировано.</Hn>
        </P>
      </div>
      ...
      <div className="mt-5">
        ...
        <P>
          В мебельной компании текучесть в моей бизнес-единице составляла <Hn>3%</Hn>. Но дело не
          только в удержании. За всю карьеру, во всех проектах, <Hn>более 15 специалистов</Hn>{' '}
      ...
      {/* Ch 6 */}
      <ChapterHeading id="ch6" label="Глава VI" title="Другие проекты" />
      <div className="mt-5">
        <P>
          Мебельная компания не была единственным проектом. Параллельно — e-commerce для частной
          клиники. Полностью офлайновая, ни одного digital-инструмента. Я увидел, что без цифровой
          инфраструктуры она не выживет. Построил всё с нуля: создал call center, внедрил AmoCRM,
          интегрировал UIS-телефонию, запустил маркетинг и сайт. 5 департаментов, 15 человек. LTV
          пациента вырос в <Hn>9 раз</Hn>. Когда проект вышел на операционную стабильность — передал
          управление и вернулся к основному фокусу.
        </P>
        <P>
          Политические кампании: <Hn>5 из 5 побед</Hn>. Муниципальный, региональный, федеральный
          уровень. Все digital-каналы: SEO, YouTube, Instagram, Дзен, TikTok, таргетированная и
      ...
      <div className="mt-5">
        <P>
          ...
          единую систему. Начал как внутренний инструмент для управления маркетплейсами, увидел
          рыночный потенциал, собрал MVP за месяц. <Strong>BIXIRUN</Strong> — фитнес-приложение с
          собственным брендом БАДов, уже в App Store.
        </P>
        <P>
          Я не разработчик. Мыслю на уровне продукта: PRD, проектная документация, системный дизайн.
          Код — AI и подрядчики. Работаю с кодом с появлением GPT, освоил стек: React, Next.js,
          Python, FastAPI, Docker. Запускаю продакшн-SaaS за месяц в одного.
        </P>
        <P>
          Каждый собственный продукт — это полигон: архитектура, юнит-экономика, масштабирование.
          То, что проверено на своих деньгах, я применяю в бизнесе.
        </P>
      </div>
