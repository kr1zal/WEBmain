...
const chapters = [
  ...
  { id: 'ch4', label: 'Глава IV', title: 'Мебельная компания', toc: 'Мебельная компания' },
...
const principles = [
  ...
  },
  {
    ...
    desc: 'Лучшее, что я создал — команды, которые работают без меня.',
  },
  {
    ...
    <>
      ...
      <div className="mt-5">
        ...
        <P>
          ...
          Работа с CPA-моделями и сложными воронками на разных гео дала глубокое понимание
          юнит-экономики трафика.
        </P>
        <P>
      ...
      <div className="mt-5">
        ...
        <P>
          Первый корпоративный опыт — агентство performance-маркетинга. Компактная команда, высокая
          концентрация экспертизы. Я увидел экономику агентского бизнеса изнутри — потенциала для
      ...
      <div className="mt-5">
        ...
        <P>
          ...
          СберМегаМаркет, Яндекс.Маркет — одни из первых в нише крупногабарита. Выручка выросла с
          300 тысяч до 26 миллионов рублей в месяц.
        </P>
        <P>
        ...
        <P>
          ...
          ответственностью. За всю карьеру, во всех проектах, <Hn>более 15 специалистов</Hn> выросли
          в руководителей направлений. Сегодня они управляют отделами в крупных компаниях. Текучесть
          в моей бизнес-единице — <Hn>3%</Hn>.
        </P>
      </div>
