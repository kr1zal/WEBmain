...
const contacts = [
  { icon: <MailIcon />, label: 'Email', href: 'mailto:kr1zal@yandex.ru' },
  { icon: <TelegramIcon />, label: 'Telegram', href: 'https://t.me/alv1nogradov' },
  { icon: <GitHubIcon />, label: 'GitHub', href: 'https://github.com/kr1zal' },
