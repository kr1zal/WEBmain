...
const speakingTopics = [
  {
    num: 'I',
    title: 'Как построить e-commerce там, где его никогда не было',
  ...
  {
    num: 'III',
    title: 'Найм и удержание в e-commerce',
    desc: 'Как собрать команду 60 человек в e-commerce и не потерять ключевых. Культура, мотивация, рост внутри.',
  },
  {
    num: 'IV',
    title: '5 маркетплейсов одновременно: мультиканальность без хаоса',
    desc: 'WB, Ozon, СберМега, Я.Маркет, KazanExpress — как управлять всем сразу. Автоматизация, фиды, логистика.',
  },
  {
    num: 'V',
    title: 'AI-контент-фабрика: 200+ видео в месяц без продакшна',
    desc: '70% операций на AI. HaiGen, Kling, n8n — что автоматизировали, что нет. Честный разбор воркфлоу.',
  },
  {
    num: 'VI',
    title: 'P&L для технаря: как IT-директору говорить на языке бизнеса',
    desc: 'Переход от «мы внедрили» к «мы заработали». Как технический лидер становится бизнес-партнёром.',
  },
]
